...
module.exports = function (name, description, options) {
    ...
    if (description) benit.description = description;
    benit.use({
    ...
    return function (benit) {
        ...
        return benit
            ...
            .on('test start', function (test) {
                if (!argv.s) console.log('Benchmarking : ' + test.name + ' x ' + test.count);
                test._pmem = new Pmem;
                test._result = [];
            ...
            .on('complete', function () {
                ...
                results.forEach(function (test, index) {
                    ...
                    console.log(helper.columns([
                        index + 1 + '. ' + test.name,
                        helper.formatNumber(test._mean, 2),
                ...
                if (options.total) {
                    ...
                    console.log('==========================================================');
                    console.log(this.title(), ' -- Total time:');
                    console.log('----------------------------------------------------------');
                    console.log(helper.columns([
                        'Name',
                        'Time ms',
                    ...
                    results.forEach(function (test, index) {
                        ...
                        console.log(helper.columns([
                            index + 1 + '. ' + test.name,
                            helper.formatNumber(test._total, 2),
                            helper.formatNumber(diff, 2)
                        ], sizes));
                    });
                    console.log('');
